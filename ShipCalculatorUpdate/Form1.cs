...
namespace ShipCalculatorUpdate
{
	public class Form1 : Form
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ShipCalculatorUpdate.Form1));
			...
			this.RemoveAllTurretWeapButton.Click += new System.EventHandler(RemoveAllTurretWeapButton_Click);
			...
			this.RemoveAllFrontWeapButton.Click += new System.EventHandler(RemoveAllFrontWeapButton_Click);
			...
			this.RemoveTurretWeapButton.Click += new System.EventHandler(RemoveTurretWeapButton_Click);
			...
			this.RemoveFrontWeapButton.Click += new System.EventHandler(RemoveFrontWeapButton_Click);
			...
			this.AddTurretWeapButton.Click += new System.EventHandler(AddTurretWeapButton_Click);
			...
			this.AddFrontWeapButton.Click += new System.EventHandler(AddFrontWeapButton_Click);
			...
			this.RemoveAllSpecialSlotButton.Click += new System.EventHandler(RemoveAllSpecialSlotButton_Click);
			...
			this.RemoveSpecialSlotButton.Click += new System.EventHandler(RemoveSpecialSlotButton_Click);
			...
			this.AddedSpecialSlotListBox.SelectedIndexChanged += new System.EventHandler(AddedSpecialSlotListBox_SelectedIndexChanged);
			...
			this.AddSpecialSlotButton.Click += new System.EventHandler(AddSpecialSlotButton_Click);
			...
			this.RemoveAllCivilSlotButton.Click += new System.EventHandler(RemoveAllCivilSlotButton_Click);
			...
			this.RemoveCivilSlotButton.Click += new System.EventHandler(RemoveCivilSlotButton_Click);
			...
			this.AddCivilSlotButton.Click += new System.EventHandler(AddCivilSlotButton_Click);
			...
			this.PriceAddComboBox.SelectedIndexChanged += new System.EventHandler(PriceAddComboBox_SelectedIndexChanged);
			this.PriceAddComboBox.SelectedValueChanged += new System.EventHandler(PriceAddComboBox_SelectedValueChanged);
			...
			this.BoriCheckBox.CheckedChanged += new System.EventHandler(BoriCheckBox_CheckedChanged);
			...
			this.StalCheckBox.CheckedChanged += new System.EventHandler(StalCheckBox_CheckedChanged);
			...
			this.ArmorThiccTextBox.TextChanged += new System.EventHandler(ArmorThiccTextBox_TextChanged);
			...
			this.HassCheckBox.CheckedChanged += new System.EventHandler(HassCheckBox_CheckedChanged);
			...
			this.RemoveEngineButton.Click += new System.EventHandler(RemoveEngineButton_Click);
			...
			this.AddEngineButton.Click += new System.EventHandler(AddEngineButton_Click);
			...
			this.SensorsCheckedListBox.SelectedIndexChanged += new System.EventHandler(SensorsCheckedListBox_SelectedIndexChanged);
			this.SensorsCheckedListBox.SelectedValueChanged += new System.EventHandler(SensorsCheckedListBox_SelectedValueChanged);
			...
			this.QualityComboBox.SelectedIndexChanged += new System.EventHandler(QualityComboBox_SelectedIndexChanged);
			...
			this.ClassComboBox.SelectedIndexChanged += new System.EventHandler(ClassComboBox_SelectedIndexChanged);
			...
			this.SizeComboBox.SelectedIndexChanged += new System.EventHandler(SizeComboBox_SelectedIndexChanged);
			...
			this.RulesLinkLabel.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(LinkLabel1_LinkClicked);
			...
			this.MenuStrip1.Items.AddRange(new System.Windows.Forms.ToolStripItem[1] { this.ToolStripMenu });
			this.MenuStrip1.Location = new System.Drawing.Point(0, 0);
			this.MenuStrip1.Name = "MenuStrip1";
			this.MenuStrip1.Size = new System.Drawing.Size(869, 24);
			this.MenuStrip1.TabIndex = 5;
			this.MenuStrip1.Text = "Вкладка";
			this.ToolStripMenu.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[3] { this.описаниеМодулейToolStripMenuItem, this.changeLogsToolStripMenuItem, this.LoadConfigurationButton });
			...
			this.описаниеМодулейToolStripMenuItem.Click += new System.EventHandler(описаниеМодулейToolStripMenuItem_Click);
			...
			this.changeLogsToolStripMenuItem.Click += new System.EventHandler(changeLogsToolStripMenuItem_Click);
			...
			this.LoadConfigurationButton.Click += new System.EventHandler(LoadConfigurationButton_Click);
			base.AccessibleRole = System.Windows.Forms.AccessibleRole.None;
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.BackColor = System.Drawing.SystemColors.ControlDark;
			base.ClientSize = new System.Drawing.Size(869, 496);
			base.Controls.Add(this.CostLabel);
			base.Controls.Add(this.SaveButton);
			base.Controls.Add(this.RulesLinkLabel);
